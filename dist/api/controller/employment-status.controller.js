...
let EmploymentStatusController = class EmploymentStatusController extends base_controller_1.BaseController {
    constructor(service) {
        super(service);
        this.service = service;
    }
};
EmploymentStatusController = __decorate([
    common_1.UseGuards(passport_1.AuthGuard('jwt'), roles_guard_1.RolesGuard),
    action_decorators_1.Feature(api_features_1.ACCESS.EMPLOYEES),
    common_1.Controller('employment-status'),
...
//# sourceMappingURL=employment-status.controller.js.map