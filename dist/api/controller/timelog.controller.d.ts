...
export declare class TimelogController extends BaseController<TimelogEntity> {
    ...
    saveLog(request: any, body: Partial<TimelogEntity>): Promise<ResponseDTO<any>>;
    editlog(request: any, body: Partial<TimelogEntity>): Promise<ResponseDTO<any>>;
    ...
    importTimeSheet(file: any, req: any): Promise<ResponseDTO<any>>;
}
