...
export declare class EmployeeController extends BaseController<EmployeeEntity> {
    ...
    importEmployees(file: any, req: any): Promise<ResponseDTO<any>>;
    searchEmployee(querystring: string): Promise<ResponseDTO<any>>;
    getByPaygroup(payGroupId: string): Promise<ResponseDTO<{
        payGroupId: string;
    }>>;
    getEmployeesWithCompleteInfo(): Promise<ResponseDTO<any>>;
}
