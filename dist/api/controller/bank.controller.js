...
let BankController = class BankController extends base_controller_1.BaseController {
...
BankController = __decorate([
    ...
    action_decorators_1.Feature(api_features_1.ACCESS.BANKS),
    common_1.Controller('bank'),
