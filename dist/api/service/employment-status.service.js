...
let EmploymentStatusService = class EmploymentStatusService extends core_service_1.CoreService {
    constructor(repo) {
        super(repo);
        this.repo = repo;
    }
...
EmploymentStatusService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(employment_status_entity_1.EmploymentStatusEntity)),
