...
export declare class EmployeeService extends CoreService<EmployeeEntity> {
    ...
    getEmployeesWithCompleteInfo(): Promise<EmployeeEntity[]>;
    checkIfEmployeeIdExists(employeeId: string): Promise<EmployeeEntity>;
    ...
    importFromFile(file: any, user: UserEntity): Promise<EmployeeEntity[]>;
